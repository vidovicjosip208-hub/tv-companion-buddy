    ...
    >
      {!showEpisodes && !showPlayer && (
        ...
        <div className="relative z-10 flex flex-col items-center justify-start pt-[7vh] px-12 w-full h-full text-center pb-[280px]">
          ...
          >
            <img src={logo} alt="Max Ovizija" className="h-[180px] w-auto" />
          </motion.div>
          ...
          <motion.p
            ...
            className="text-muted-foreground text-lg leading-relaxed mb-10 line-clamp-3 max-w-[700px] min-h-[5.5rem]"
          >
            {details.description}
          </motion.p>
